...
def get_page(url, controller, circuit, results, distance):
    ...
    results.write(hostname + "," + str(time) + "," + str(distance) + "\n")
...
def main():
    ...
    historyList = readinFile()
    historyList[0] = 'yahoo.com'
    experiment_tor(historyList)

# =====================================================================================
# Run the experiment using our algorithm.
# =====================================================================================
def experiment_smartor(history):
    results_smartor = open("results_smartor_Anas.txt", "a")
